...
const projects: Project[] = [
  ...
  },
  {
    id: "minillm",
    title: "MiniLLM",
    shortDescription: "Transformer built from scratch — no PyTorch, no HuggingFace, just NumPy",
    fullDescription: "A ground-up implementation of a language model using only Python and NumPy. Every component — tokenization, Word2Vec Skip-Gram with Negative Sampling, and attention — is hand-built for deep understanding. Trained on ~1M words from Dostoevsky novels over 30+ hours on a laptop CPU. The embeddings learned that 'crime' and 'punishment' belong together without ever seeing Crime and Punishment.",
    icon: Brain,
    tags: ["AI/ML", "NLP", "Deep Learning"],
    technologies: ["Python", "NumPy", "Word2Vec", "Skip-Gram", "Negative Sampling", "Bigram Models"],
    repoUrl: "https://github.com/07Codex07/Mini_LLM",
    features: [
      "Character-level tokenizer and bigram probability model built from scratch",
      "Word2Vec Skip-Gram with Negative Sampling on ~1M words of Dostoevsky",
      "Dual embedding matrices to prevent gradient collision — discovered independently",
      "Frequency-based negative sampling (raised to 0.75 power, per original paper)",
      "Semantic relationships emerge without supervision (crime↔punishment: 0.878 cosine sim)",
      "Self-attention and transformer block in progress",
    ],
  },
  {
    id: "marketregime",
    title: "Market Regime Detection",
    shortDescription: "Financial market regimes detected via semantic geometry of news embeddings",
    fullDescription: "A novel approach to detecting financial market regimes using the geometric structure of FinBERT news embeddings rather than traditional lagging price indicators. Unsupervised clustering on 768-dimensional vectors from 1,500+ Economic Times headlines identifies semantically coherent regimes corresponding to distinct NIFTY 50 market conditions. Intra-cluster variance correlates with future volatility — an early warning system built from text.",
    icon: Database,
    ...
    features: [
      ...
      "K-Means + DBSCAN clustering with silhouette score and Davies-Bouldin optimization",
      "Intra-cluster variance as a leading volatility indicator",
      "Regime transition probability matrices for text-based forecasting",
      "Aligned with 30-minute NIFTY 50 OHLCV bars for statistical validation",
    ],
  },
  {
    id: "chatgptmemory",
    title: "ChatGPT Memory From Scratch",
    shortDescription: "LLM memory system — FAISS + RAG + summarisation, zero LangChain",
    fullDescription: "A ground-up implementation of a ChatGPT-style persistent memory system using FAISS vector search, retrieval-augmented generation, and LLM-based summarisation — with zero LangChain. Built to understand how memory actually works in production LLM systems, not just call abstractions. Every retrieval, summarisation, and injection step is written and understood explicitly.",
    icon: Brain,
    tags: ["AI/ML", "RAG", "LLMs", "NLP"],
    technologies: ["Python", "FAISS", "RAG", "LLM Summarisation", "CLI", "NumPy"],
    repoUrl: "https://github.com/07Codex07/ChatGPT_Memory_From_Scratch",
    features: [
      "FAISS-based vector store for semantic memory retrieval",
      "RAG pipeline for injecting relevant memories into context",
      "LLM summarisation to compress long-term memory without context overflow",
      "Zero LangChain — every component implemented explicitly from first principles",
      "CLI interface for interactive chat with persistent memory",
      "Demonstrates how production memory systems actually work under the hood",
    ],
  },
  {
    id: "hivebigdata",
